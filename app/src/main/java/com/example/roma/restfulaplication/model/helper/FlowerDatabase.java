...
public class FlowerDatabase extends SQLiteOpenHelper {
    ...
    public void addFlower(Flower flower) {
        ...
        values.put(Constants.DATABASE.PHOTO, Utils.getPictureByteArray(flower.getPicture()));

        try {
            db.insertWithOnConflict(Constants.DATABASE.TABLE_NAME, null, values,CONFLICT_NONE);
        } catch (Exception e) {
